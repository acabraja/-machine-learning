...
%        [x, bc, wc] = ratio_black_white(A, interval_black,.....)
    ...
    blackPixelMask = abs(A(:,:,1) - interval_black(1)) < precision(1) ...
        & abs(A(:,:,2) - interval_black(2)) < precision(2) ...
        & abs(A(:,:,3) - interval_black(3)) < precision(3);
    whitePixelMask = abs(A(:,:,1) - interval_white(1)) < precision(1) ...
        & abs(A(:,:,2) - interval_white(2)) < precision(2) ...
        & abs(A(:,:,3) - interval_white(3)) < precision(3);
